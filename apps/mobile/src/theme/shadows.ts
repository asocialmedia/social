...
// `:root:not(.dark) .btn-3d` (apps/web's light-mode override)
export const LOGIN_BUTTON_SHADOWS_LIGHT =
  "inset 0 0 0 1px rgba(255, 255, 255, 0.35), inset 0 1.5px 2px rgba(255, 255, 255, 0.55), 0 0 0 1px rgba(170, 60, 0, 0.45), 0 1px 2px rgba(0, 0, 0, 0.1), 0 3px 6px -2px rgba(0, 0, 0, 0.14)";

// `:root:not(.dark) .btn-3d:active`
