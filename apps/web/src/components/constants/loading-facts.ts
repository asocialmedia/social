export const loadingFacts = {
  ...
  asm: [
    "Legend says Asocialmedia's dark mode was inspired by a midnight coding session",
    "Asocialmedia once fixed a bug by itself... or maybe that was just a dream",
    "Some say Asocialmedia's animations are so smooth, they can hypnotize developers",
    "Asocialmedia's creator once coded for 48 hours straight, fueled only by memes",
    "Asocialmedia's first commit message was 'it works... somehow'",
    "They say every time Asocialmedia crashes, a developer learns to write better error handling",
    "Asocialmedia's loading screen has seen more developers fall asleep than any bed",
    "The aurora effects were inspired by a coffee-induced hallucination",
    "Asocialmedia's code is so clean, it makes Marie Kondo jealous",
    "Some developers swear they've seen Asocialmedia write its own features at 3 AM",
  ],
  dev: [
