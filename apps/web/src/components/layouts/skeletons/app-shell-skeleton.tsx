...
export default function AppShellSkeleton() {
  return (
    <div aria-hidden className="relative flex h-dvh overflow-hidden">
      <aside className="border-border/60 hidden w-72 shrink-0 flex-col gap-6 border-r px-2.5 pt-3 pb-5 lg:flex">
      ...
      <aside className="border-border/60 hidden w-72 shrink-0 flex-col gap-4 border-l px-2.5 pt-6 pb-5 xl:flex">
        <RightRailSkeleton />
      </aside>
    </div>
  );
