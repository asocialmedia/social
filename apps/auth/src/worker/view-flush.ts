...
export async function flushViewDeltas(postIds: string[]): Promise<FlushResult> {
...
export async function consumeViewStream(consumerName: string): Promise<number> {
